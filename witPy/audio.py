...
WIT_AI_KEY = "OK3GYG6TYL4YGW7RTSXNCA4AFSK4Y2JD" # Wit.ai keys are 32-character uppercase alphanumeric strings
try:
    print("Wit.ai thinks you said " + r.recognize_wit(audio, key=WIT_AI_KEY))
    call(["say", r.recognize_wit(audio, key=WIT_AI_KEY)])
    voiceInput = r.recognize_wit(audio, key=WIT_AI_KEY)
    print(audio) 
except sr.UnknownValueError:
